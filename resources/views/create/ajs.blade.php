            ...
            <div class="col-6">
                ...
                <form method="POST" action="/index/ajs">
					...
					<div class="form-group my-3">
                        ...
                        <input type="number" class="form-control @error('id_asesor') is-invalid @enderror" id="id_asesor" name="id_asesor" placeholder="id asesor" value="{{old('id_asesor')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="number" class="form-control @error('no_sertifikat') is-invalid @enderror" id="no_sertifikat" name="no_sertifikat" placeholder="nomer sertifikat" value="{{old('no_sertifikat')}}">
