            ...
            <div class="col-6">
                ...
                <form method="POST" action="/index/pi">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="number" class="form-control @error('id_instrumen_asesmen') is-invalid @enderror" id="id_instrumen_asesmen" name="id_instrumen_asesmen" placeholder="id instrumen asesmen" value="{{old('id_instrumen_asesmen')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea type="text" class="form-control @error('jawaban_asesor_verifikasi') is-invalid @enderror" id="jawaban_asesor_verifikasi" name="jawaban_asesor_verifikasi" placeholder="jawaban asesor verifikasi"> {{old('jawaban_asesor_verifikasi')}}</textarea>
