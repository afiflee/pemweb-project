            ...
            <div class="col-6">
                ...
                <form method="POST" action="/datass/{{$syaratsertifikasi->id}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="number" class="form-control @error('id_ref_jenis_sertifikasi') is-invalid @enderror" id="id_ref_jenis_sertifikasi" name="id_ref_jenis_sertifikasi" placeholder="id jenis sertifikasi" value="{{ $syaratsertifikasi ->  id_ref_jenis_sertifikasi}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control @error('is_aktif') is-invalid @enderror" id="is_aktif" name="is_aktif" placeholder="true / false" value="{{ $syaratsertifikasi -> is_aktif}}">
